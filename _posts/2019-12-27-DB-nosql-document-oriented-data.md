...
데이터의 성격을 알아낼 수 있다면 데이터를 꺼낼 수 있다. 어떠한 속성을 이용해서...! 
변수를 통해 저장해두면 다른 곳에서 쓸 수 있다.
find를 통해 반환한 커서는 연속적인 객체다. 지나가버리면 잊혀지므로! findOne을 사용해 document로서 활용해야 한다.
...
아래의 코드를 통해서 None Unique 인덱스를 만들 수 있다.

```
db.products.createIndex({'name':1}) 
```

아래의 코드를 통해서 인덱스 구성을 확인할 수 있다. 
