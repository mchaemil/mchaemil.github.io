...
- ps. bootstrap 은 참 편한 것 같다... 그 위력이 이제야 조금씩 느껴진다.(적용의 결과를 확인하고서, 왜 부트스트랩을 사람들이 많이 사용하는지 알게 됐다... 많이 편하다..)
...
사용자에게 보여지는 화면은 부트스트랩을 통해서 디자인을 다듬었다.
특별하게 디자인적 요소를 가미한 것은 아니고, [가장 단순한 폼 디자인(링크)](https://getbootstrap.com/docs/4.4/components/forms/#overview) 을 가져와서 마크업과 디자인을 적용했다.
