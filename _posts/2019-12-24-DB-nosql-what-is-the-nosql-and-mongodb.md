...
**문서가 생성이 되면 저장 공간을 할당한다.** 즉, insert 전까지 콜렉션이 생성되지 않는다!!
...
리터럴은 어떤 데이터를 표기하는 법
{} - 객체를 표현할 때 사용하는 표기법
[] - 배열, 리스트, Document 를 표현하느 표기법 



#### collection
create collection 으로 문서를 담는 그릇을 미리 만들어 놓을 수도 있지만!! 대부분은 데이터를 넣을 때 생성이 된다. 
